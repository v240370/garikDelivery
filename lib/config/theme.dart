...
class AppThemeData{
  ...
  // Color colorPrimary = Color(0xff668798); // restaurants and vmarkets
  // Color colorCompanion = Color(0xff009688); // restaurants and vmarkets
  Color colorPrimary = Color(0xff66b88c); // market & markets
  Color colorCompanion = Color(0xff029600); // market & markets
