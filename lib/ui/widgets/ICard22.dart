...
class ICard22 extends StatefulWidget {
  ...
  final TextStyle text9Style;
  final TextStyle text10Style;
  ...
  ICard22({this.color = Colors.white, this.colorRoute = Colors.black,
    ...
    this.text9Style, this.text10Style,
              ...
              Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 10,),
                      Expanded(child: Text(widget.text6, style: _text6Style, overflow: TextOverflow.ellipsis,)),
                      Text(widget.text9, style: widget.text9Style, overflow: TextOverflow.ellipsis,),     // Driver fee
                      Text(widget.text10, style: widget.text10Style, overflow: TextOverflow.ellipsis,),
                    ],
                  )
              ),
              SizedBox(height: 5,),
